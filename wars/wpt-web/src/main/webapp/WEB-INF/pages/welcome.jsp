		...
		<youi:panel  caption="快捷访问" column="6" height="611" >
			<youi:form id="form_s" action="esb/fileupload/myservice/myfile.html">
				<youi:fieldLayout>
					...
					<youi:fieldFile property="file" caption="file"></youi:fieldFile>
				</youi:fieldLayout>
			</youi:form>
			<div id="container">
		...
		<youi:panel caption="我的消息" column="6" height="150">
			<youi:form id="form_s" action="a.json">
				<youi:fieldLayout>
					...
					<youi:fieldCalendar property="cale" format="yyyy-MM-dd HH:mm" textFormat="yyyy-MM-dd HH:mm" caption="日期"></youi:fieldCalendar>
					<youi:fieldCalendar property="cale1" format="yyyy-MM-dd HH:mm" textFormat="yyyy-MM-dd HH:mm" caption="日期"></youi:fieldCalendar>
					<youi:fieldSpinner step="2" styleClass="input-group" property="spinner" caption="spinner"></youi:fieldSpinner>
				</youi:fieldLayout>
			</youi:form>
