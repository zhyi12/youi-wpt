...
<youi:html i18n="i18n.index" title="i18n.index.title">
	...
	<youi:style href="/styles/mui/mui.min.css"></youi:style>
	...
	<youi:script src="/scripts/3.0/lib/jquery-1.9.1.min.js"></youi:script>
	<youi:script src="/scripts/mui/mui.min.js"></youi:script>
